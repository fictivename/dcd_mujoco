...
"""Register Cheetah environments with OpenAI gym."""
...
def register(env_id, entry_point, reward_threshold=0.95, max_episode_steps=200):
  """Register a new environment with OpenAI gym based on id."""
  assert env_id.startswith("HalfCheetah")
