...
parser.add_argument(
    '--test_env_names',
    type=str,
    default='HalfCheetahMass-v0',  # 'MultiGrid-SixteenRooms-v0,MultiGrid-Labyrinth-v0,MultiGrid-Maze-v0',
...
parser.add_argument(
    '--env_name',
    type=str,
    default='HalfCheetahMassAdversarial-v0',  # 'MultiGrid-GoalLastAdversarial-v0',
